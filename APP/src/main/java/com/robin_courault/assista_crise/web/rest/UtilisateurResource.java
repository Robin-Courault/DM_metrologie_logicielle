...
import com.robin_courault.assista_crise.service.UtilisateurService;
...
/**
 * REST controller for managing {@link com.robin_courault.assista_crise.domain.Utilisateur}.
 */
@RestController
...
public class UtilisateurResource {
     ...
     */
    @GetMapping("")
    public List<UtilisateurDTO> getAllUtilisateurs(@RequestParam(name = "filter", required = false) String filter) {
        if ("sinistre-is-null".equals(filter)) {
            LOG.debug("REST request to get all Utilisateurs where sinistre is null");
            return utilisateurService.findAllWhereSinistreIsNull();
        }

        if ("citoyen-is-null".equals(filter)) {
            LOG.debug("REST request to get all Utilisateurs where citoyen is null");
            return utilisateurService.findAllWhereCitoyenIsNull();
        }

        if ("agent-is-null".equals(filter)) {
            LOG.debug("REST request to get all Utilisateurs where agent is null");
            return utilisateurService.findAllWhereAgentIsNull();
        }

        if ("administrateur-is-null".equals(filter)) {
            LOG.debug("REST request to get all Utilisateurs where administrateur is null");
            return utilisateurService.findAllWhereAdministrateurIsNull();
        }
