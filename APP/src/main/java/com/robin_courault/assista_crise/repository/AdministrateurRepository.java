...
public interface AdministrateurRepository extends JpaRepository<Administrateur, Long> {
    ...
    @Query(
        value = "select administrateur from Administrateur administrateur left join fetch administrateur.utilisateur",
    ...
    @Query("select administrateur from Administrateur administrateur left join fetch administrateur.utilisateur")
    List<Administrateur> findAllWithToOneRelationships();

    @Query(
        "select administrateur from Administrateur administrateur left join fetch administrateur.utilisateur where administrateur.id =:id"
    )
