...
public class DemandeAsserts {
    ...
    public static void assertDemandeUpdatableFieldsEquals(Demande expected, Demande actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getEtatDemande()).as("check etatDemande").isEqualTo(expected.getEtatDemande()))
    ...
    public static void assertDemandeUpdatableRelationshipsEquals(Demande expected, Demande actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSinistre()).as("check sinistre").isEqualTo(expected.getSinistre()))
            .satisfies(a -> assertThat(a.getCrise()).as("check crise").isEqualTo(expected.getCrise()))
            .satisfies(a -> assertThat(a.getOffreses()).as("check offreses").isEqualTo(expected.getOffreses()));
    }
}
